...
const PROFILES = Object.freeze({
    ...
    kb: Object.freeze([
        // Knowledge-base documentation & testing pipeline
        'kb-init',
        'kb-query',
        // Fill (deep semantic extraction)
        'kb-fill',
        'kb-fill-ai',
        'kb-fill-apis',
        'kb-fill-from-prd',
        ...
        // Regression
        'kb-regression',
        'kb-regression-analyze',
        'kb-regression-execute',
        'kb-regression-generate',
    ]),
    full: '*',
});
// ---------------------------------------------------------------------------
 ...
 */
const PROFILE_RANK = Object.freeze(['core', 'standard', 'kb', 'full']);
/**
